...
from nutev.search.strategy_execution_ledger import create_search_run, finish_search_run, record_execution_artifact
    ...
    *,
    ...
    for provider in requested:
        ...
        try:
            ...
            result = ProviderResult(provider=provider, query=provider_query, status="failed", error=str(exc))
